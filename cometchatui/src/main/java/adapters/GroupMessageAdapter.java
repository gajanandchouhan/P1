    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final Cursor cursor) {
        ...
        switch (holder.getItemViewType()){
            case LEFT_TEXT_MESSAGE:
                ...
                break;
            case RIGHT_TEXT_MESSAGE:
                RightMessageViewHolder rightTextMessageHolder = (RightMessageViewHolder) holder;
                ...
                break;
            case RIGHT_STICKER_MESSAGE:
                RightMessageViewHolder rightStickerMessageHolder = (RightMessageViewHolder) holder;
                rightStickerMessageHolder.rightArrow.setVisibility(GONE);
...
//                            rightImageDownloadingViewHolder.imageMessage.setEnabled(false);
            ...
            case RIGHT_IMAGE_MESSAGE:
                RightImageVideoViewHolder rightImageMessageHolder = (RightImageVideoViewHolder) holder;
...
//                            rightImageViewHolder.imageMessage.setEnabled(false);
            ...
            case RIGHT_VIDEO_MESSAGE:
                RightImageVideoViewHolder rightVideoMessageHolder = (RightImageVideoViewHolder) holder;
            ...
            try {
                ClickableSpan span = new ClickableSpan() {
                    ...
                    public void onClick(View widget) {
                        ...
                        intent.putExtra(StaticMembers.INTENT_ROOM_NAME, channel);
