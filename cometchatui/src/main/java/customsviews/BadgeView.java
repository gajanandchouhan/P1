...
public class BadgeView extends TextView {
    ...
    private static final int DEFAULT_MARGIN_DIP = 7;
    private static final int DEFAULT_LR_PADDING_DIP = 7;
    private static final int DEFAULT_CORNER_RADIUS_DIP = 8;
    private static final int DEFAULT_POSITION = POSITION_TOP_RIGHT;
    private static final int DEFAULT_BADGE_COLOR = Color.parseColor("#FFFFFF"); //Color.WHITE;
    ...
    public BadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
        ...
        DEFAULT_TEXT_COLOR = (int) CometChat.getInstance(context)
                .getCCSetting(new CCSettingMapper(SettingType.UI_SETTINGS, SettingSubType.COLOR_PRIMARY));
        Logger.error("DEFAULT_TEXT_COLOR : "+DEFAULT_TEXT_COLOR);
