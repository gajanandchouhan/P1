                ...
                simpleTarget = new SimpleTarget<BitmapDrawable>() {
                    ...
                    public void onLoadFailed(@Nullable Drawable errorDrawable) {
                        ...
                        if (downloadAttempt < 1) {
                            ...
                            if(PreferenceHelper.getContext() instanceof Activity && !((Activity)PreferenceHelper.getContext()).isFinishing()) {

                                RequestBuilder drawableRequest = Glide.with(PreferenceHelper.getContext())
