...
public class NewsAapter extends RecyclerView.Adapter<NewsAapter.ItemViewHolder> {
    ...
    public void onBindViewHolder(ItemViewHolder holder, int position) {
        ...
        holder.textViewDateTime.setText(CommonUtils.getformattedDateFromString(ConstantLib.INPUT_DATE_TIME_FORMATE, ConstantLib.OUTPUT_DATE_TIME_FORMATE, list.get(position).getCreated_at(), true,list.get(position).getTimezone()));
