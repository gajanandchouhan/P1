...
public class SubmitPresenter extends BasePresenter<SubmitView> {
    ...
    public SubmitPresenter(Context mContext) {
        super(mContext);
    }

    @Override
    protected void setView(SubmitView submitView) {
        this.view = submitView;
    }

    public void addShare(RequestBody params, Map<String, String> headers) {
        ...
        apiController.callMultpleFileUpload(RequestType.REQ_ADD_SHARE, new ResponseHandler<BaseResponseModel>() {
            @Override
